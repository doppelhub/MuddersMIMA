//Copyright 2022-2023(c) John Sullivan
	...
	#define JOYSTICK_MAX_ALLOWED_PERCENT      92 //joystick only outputs up   to 90% of VCC //+2% guardband
	#define JOYSTICK_MIN_ALLOWED_PERCENT       8 //joystick only outputs down to 10% of VCC //-2% guardband
